...
<https://docs.djangoproject.com/en/5.2/ref/settings/>`_ can be used.
...
.. py:data:: DEBUG_PROPAGATE_EXCEPTIONS
    ...
    https://docs.djangoproject.com/en/5.2/ref/settings/#debug-propagate-exceptions
...
.. py:data:: FILE_UPLOAD_HANDLERS
    ...
    temporary files. See
    https://docs.djangoproject.com/en/5.2/ref/settings/#file-upload-handlers
...
.. py:data:: LOCALE_PATHS
    ...
    See https://docs.djangoproject.com/en/5.2/ref/settings/#locale-paths
...
.. py:data:: MEDIA_URL
    ...
    See https://docs.djangoproject.com/en/5.2/ref/settings/#media-url
...
.. py:data:: SESSION_COOKIE_DOMAIN
    ...
    See
    https://docs.djangoproject.com/en/5.2/ref/settings/#session-cookie-domain
...
.. py:data:: STATIC_URL
    ...
    See https://docs.djangoproject.com/en/5.2/ref/settings/#static-url
